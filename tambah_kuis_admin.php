          ...
          <div class="flex-grow-1">
            ...
            <div class="select-wrap">
              <select class="pill-input" id="bagianInput" name="bagian" required>
                ...
                <option value="Teknis Penyelenggara Pemilu">Teknis Penyelenggara Pemilu</option>
                <option value="Partisipasi Hubungan Masyarakat">Partisipasi Hubungan Masyarakat</option>
